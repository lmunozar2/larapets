...
{{-- Cards --}}
<div class="flex flex-wrap gap-4 items-center justify-center text-white">
    @if(Auth::user()->role == 'Administrador')


    {{-- Module users --}}
    <div class="card bg-[#fff6] w-96 shadow-sm">
        <figure>
            <img src="images/user-statistics.png" alt="Users" />
        </figure>
        <div class="card-body">
            <h2 class="card-title">Module Users</h2>
            <ul class="list bg-[#0006] rounded-box shadow-md">

                <li class="p-4 pb-2 text-xs opacity-60 tracking-wide">Stadistic</li>
                ...
                <li class="list-row">
                    ...
                    <div>
                        <div>Total Users</div>
                        <div class="text-xs uppercase font-semibold opacity-60">Count</div>
                    </div>
    ...
    <div class="card bg-[#fff6] w-96 shadow-sm">
        <figure>
            <img src="images/pets-estatistics.png" alt="Shoes" />
        </figure>
        <div class="card-body">
    ...
    <div class="card bg-[#fff6] w-96 shadow-sm">
        <figure>
            <img src="images/adoption-statistics.png" alt="Shoes" />
        </figure>
        <div class="card-body">
            <h2 class="card-title">Module Adoption</h2>
            <ul class="list bg-[#0006] rounded-box shadow-md">
            ...
            <div class="card-actions justify-end">
                <a class="btn btn-outline hover:bg-[#fff6] hover:text-white mt-4" href="{{ url('adoptions') }}">Enter
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-6" fill="currentColor" viewBox="0 0 256 256">
                        <path
                            d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Zm29.66-93.66a8,8,0,0,1,0,11.32l-40,40a8,8,0,0,1-11.32-11.32L140.69,128,106.34,93.66a8,8,0,0,1,11.32-11.32Z">
                        </path>
        ...
        <div class="card text-white bg-[#000a] w-96 shadow-sm">
            <figure class="h-[240px]">
                <img class="object-cover w-full h-full" src="images/user-statistics.png" alt="users" />
            </figure>
            <div class="card-body">
                <h2 class="card-title">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-6" fill="currentColor" viewBox="0 0 256 256">
        ...
        <div class="card text-white bg-[#000a] w-96 shadow-sm">
            <figure class="h-[240px]">
                <img class="object-cover w-full h-full" src="images/adoption-statistics.png" alt="pets" />
            </figure>
            <div class="card-body">
                <h2 class="card-title">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-6" fill="currentColor" viewBox="0 0 256 256">
        ...
        <div class="card text-white bg-[#000a] w-96 shadow-sm">
            <figure class="h-[240px]">
                <img class="object-cover w-full h-full" src="images/pets-estatistics.png" alt="Shoes" />
            </figure>
            <div class="card-body">
                <h2 class="card-title">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-6" fill="currentColor" viewBox="0 0 256 256">
    ...
    <dialog id="modal_error" class="modal">
        <div class="modal-box">
            <h3 class="text-lg font-blond mb-4">
                Sorry!
            </h3>
        ...
        <form action="dialog" class="modal-backdrop"> </form>
    </dialog>
