...
<div class="datalist  flex justify-center items-center flex-col gap-4">
    ...
    <a href="{{ url('myadoptions/'. $adopt->id) }}" class="btn btn-outline text-white hover:text-black">
        <svg xmlns="http://www.w3.org/2000/svg" class="size-6" fill="currentColor" viewBox="0 0 256 256">
            <path
    ...
    @empty
    <p class="text-center my-20 text-white font-bold text-xl">No Adoptions yet!</p>
    @endforelse
</div>
